...
public class ShadowscytheHouseMerge
{
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            ...
            "Mode: [select] only\nShould the bot buy \"Sepulchure's Wing House\" ?",
            false
        ),
        new Option<bool>(
            "48875",
            "Shadow Family Quarters",
            "Mode: [select] only\nShould the bot buy \"Shadow Family Quarters\" ?",
            false
        ),
        new Option<bool>(
            "48845",
            "Moglinster Rug",
            "Mode: [select] only\nShould the bot buy \"Moglinster Rug\" ?",
            false
        ),
        new Option<bool>(
            "48844",
            "Desk of Doom",
            "Mode: [select] only\nShould the bot buy \"Desk of Doom\" ?",
            false
        ),
        new Option<bool>(
            "48846",
            "Crib of Doom",
            "Mode: [select] only\nShould the bot buy \"Crib of Doom\" ?",
            false
        ),
        new Option<bool>(
            "48847",
            "World Domination Globe",
            "Mode: [select] only\nShould the bot buy \"World Domination Globe\" ?",
            false
        ),
        new Option<bool>(
            "48851",
            "Totally Dead Plant",
            "Mode: [select] only\nShould the bot buy \"Totally Dead Plant\" ?",
            false
        ),
        new Option<bool>(
            "48848",
            "Experiments",
            "Mode: [select] only\nShould the bot buy \"Experiments\" ?",
            false
        ),
        new Option<bool>(
            "48850",
            "Toxic Cauldron",
            "Mode: [select] only\nShould the bot buy \"Toxic Cauldron\" ?",
            false
        ),
        new Option<bool>(
            "48852",
            "Scattered LegOWs",
            "Mode: [select] only\nShould the bot buy \"Scattered LegOWs\" ?",
            false
        ),
        new Option<bool>(
            "48856",
            "Bone Blocks",
            "Mode: [select] only\nShould the bot buy \"Bone Blocks\" ?",
            false
        ),
        new Option<bool>(
            "48857",
            "Bone Phone",
            "Mode: [select] only\nShould the bot buy \"Bone Phone\" ?",
            false
        ),
        new Option<bool>(
            "48853",
            "Chattering Teeth",
            "Mode: [select] only\nShould the bot buy \"Chattering Teeth\" ?",
            false
        ),
        new Option<bool>(
            "48855",
            "Bone Pyramid",
            "Mode: [select] only\nShould the bot buy \"Bone Pyramid\" ?",
            false
        ),
        new Option<bool>(
            "48854",
            "Jack-in-the-Box",
            "Mode: [select] only\nShould the bot buy \"Jack-in-the-Box\" ?",
            false
        ),
        new Option<bool>(
            "48860",
            "Green Floor Sludge",
            "Mode: [select] only\nShould the bot buy \"Green Floor Sludge\" ?",
            false
        ),
        new Option<bool>(
            "48863",
            "Shadow Side Table",
            "Mode: [select] only\nShould the bot buy \"Shadow Side Table\" ?",
            false
        ),
        new Option<bool>(
            "48865",
            "Bottles Table (L)",
            "Mode: [select] only\nShould the bot buy \"Bottles Table (L)\" ?",
            false
        ),
        new Option<bool>(
            "48864",
            "Bottles Table (R)",
            "Mode: [select] only\nShould the bot buy \"Bottles Table (R)\" ?",
            false
        ),
        new Option<bool>(
            "48866",
            "Shadow Kitchen",
            "Mode: [select] only\nShould the bot buy \"Shadow Kitchen\" ?",
            false
        ),
    };
}
