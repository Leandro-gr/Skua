...
public class EtherstormGoodMerge
{
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            "11290",
            "Golden Dragoon Helm",
            "Mode: [select] only\nShould the bot buy \"Golden Dragoon Helm\" ?",
            false
        ),
        new Option<bool>(
            "11292",
            "Ultra Dragoon Lance",
            "Mode: [select] only\nShould the bot buy \"Ultra Dragoon Lance\" ?",
            false
        ),
        new Option<bool>(
            "11267",
            "Whisper of the Conquerer",
            "Mode: [select] only\nShould the bot buy \"Whisper of the Conquerer\" ?",
            false
        ),
        new Option<bool>(
            "11316",
            "Golden Dragoon",
            "Mode: [select] only\nShould the bot buy \"Golden Dragoon\" ?",
            false
        ),
    };
}
